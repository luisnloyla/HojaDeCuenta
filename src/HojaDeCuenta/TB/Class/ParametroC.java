...
public class ParametroC {
    ...
    public ParametroC(int Id_Parametro, String Codigo, String Descripcion, int Id_Parametro_Origen, String FlagActivo) {
    ...
    public static List<ParametroC> getParametroTC() throws SQLException {                
        ParametroBE ParametroBE = new ParametroBE(1, 0, "", "", 0,new V().cFlagActivo);
        ...
        for (ParametroBE obj : objParametroBE) {
            ParametroC utc = new ParametroC(obj.getId_Parametro() , obj.getCodigo(), obj.getDescripcion(), obj.getId_Parametro_Origen(),obj.getFlagActivo());
            objParametroTC.add(utc);
        }
        if (objParametroBE.size()==0) {
            ParametroC utc = new ParametroC(0, "", "", 0,new V().cFlagInActivo);
            objParametroTC.add(utc);
        }
