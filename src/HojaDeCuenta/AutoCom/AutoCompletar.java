...
//                    }
    ...
    public static ArrayList<String> lista(int accion,String txt) throws SQLException{
        ArrayList<String> items = new ArrayList<>();
        if (accion == 5) {//parametros
            ParametroBE ParametroBE = new ParametroBE(5, 0, "", new V().cadenaTerminada(txt, "descripcion"), 0,0,new V().cFlagActivo);
            cParametroBLL ParametroBLL= new cParametroBLL();            
            List<ParametroBE> aPar = ParametroBLL.Leer(new Coneccion(), ParametroBE);
            for (ParametroBE aPar1 : aPar) {
                items.add(aPar1.getDescripcion());
            }            
        }
